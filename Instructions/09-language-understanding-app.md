---
lab:
  title: Language Understanding アプリを作成する (非推奨)
  module: Module 5 - Creating Language Understanding Solutions
---

# Azure で可能 - Language Understanding アプリを作成する
...
- *作成(オーサリング)* リソース: Language Understanding アプリの定義、トレーニング、およびテストに使用されます。 Azure サブスクリプションの **Language Understanding - オーサリング** リソースである必要があります。
