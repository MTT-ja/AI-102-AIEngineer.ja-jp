...
1. 左側のペインで、 **[モデルのトレーニング]** ページを選択して、 **[トレーニング ジョブ]** を選択します。
...
6. モデルが展開されたら、 **[展開のテスト]** ページで、 **[運用環境]** 展開を選択します。
...
4. モデルが展開されたら、 **[展開のテスト]** ページで **[運用環境]** 展開を選択して、それを次のテキストでテストします。
...
1. Language Studio の **[モデルの展開]** ページで **[運用環境]** 展開を選びます。 次に **[予測 URL の取得]** をクリックします。
