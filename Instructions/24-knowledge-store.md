...
2. **[BLOB コンテナー]** を展開して、そのストレージ アカウントでコンテナーを表示します。 ソース データが格納されている **margies** コンテナーの他に、**margies-images** と **margies-knowledge** という 2 つの新しいコンテナーがあるはずです。 これらは、インデックス作成プロセスによって作成されたものです。
